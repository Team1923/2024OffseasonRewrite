...
public class SourceSubwooferRanged435 extends SequentialCommandGroup {
  /** Creates a new SourceSubwooferRanged435. */
  public SourceSubwooferRanged435() {
    ...
    addCommands(
      ...
      PathPlannerHelpers.commandPathFrom("3ToStagedRanged"),
      new ShootGamePiece(),

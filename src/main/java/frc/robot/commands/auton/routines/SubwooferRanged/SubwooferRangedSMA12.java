...
public class SubwooferRangedSMA12 extends SequentialCommandGroup {
  /** Creates a new SubwooferRangedSMA12. */
  public SubwooferRangedSMA12() {
    ...
    addCommands(
      ...
      // Note 1
      new ParallelDeadlineGroup(
        PathPlannerHelpers.commandPathFrom("AmpTo1"),
        new DeployIntakeCommand()
      ),
      ...
      // Note 2
      new ParallelDeadlineGroup(
        PathPlannerHelpers.commandPathFrom("CloseRangedTo2"),
        new DeployIntakeCommand()
      ),
